                                ...
                                <div className="h-full w-full flex flex-col p-3 justify-between group/item  rounded-xl">
                                    ...
                                    <div className="flex w-full">
                                        {slide.attributes.tags?.data.map((tag: any) => (
                                            <p className="text-xs text-primary-1 outline outline-primary-1 outline-[1px] rounded-full px-2 py-1 mr-2 text-opacity-100 hover:bg-blue-300/30" key={tag.attributes.tag}>{tag.attributes.tag}</p>
                                        ))}
                                    </div>
                                </div>
                            </li>
