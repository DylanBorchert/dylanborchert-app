                ...
                <div className="flex flex-col justify-center p-5 h-full  m-auto sm:m-0">
                    ...
                    <div className="flex sm:gap-5 sm:justify-start justify-between">
                        <a href={`https://strapi.phantommedia.online${content.resume.data?.attributes.url}`} target="_blank">
                            <div className="p-2 dark:bg-white/10 bg-black/10  px-5 py-2 hover:bg-primary-1 hover:text-black text-center rounded-full text-sm sm:mx-0 mt-2 mx-auto transition duration-400 ease-in-out">
                                <p>My Resume</p>
                            </div>
                        </a>
                        <Link href="/Contact">
